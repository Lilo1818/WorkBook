package com.mci.firstidol.view.bgabanner;
...
import com.mci.firstidol.view.bgabanner.transformer.AccordionPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.AlphaPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.CubePageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.DefaultPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.DepthPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.FadePageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.FlipPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.RotatePageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.StackPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.ZoomCenterPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.ZoomFadePageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.ZoomPageTransformer;
import com.mci.firstidol.view.bgabanner.transformer.ZoomStackPageTransformer;
...
//        }
        ...
        pointRealContainerLp.addRule(RelativeLayout.CENTER_HORIZONTAL);
        pointRealContainerLp.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        tipLp.addRule(RelativeLayout.ABOVE, R.id.banner_pointContainerId);
    }
