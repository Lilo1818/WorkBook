...
public class TouchImageView extends ImageView {
    ...
    private static TouchImageViewListener touchImageViewListener;
...
//                mService.get().mOnClickListener.onClick(mService.get());
                touchImageViewListener.touchImageViewClick(mService.get());
//            }
        }
    }
    public static void setTouchImageViewListener(
			TouchImageViewListener touchImageViewListener) {
		TouchImageView.touchImageViewListener = touchImageViewListener;
	}
