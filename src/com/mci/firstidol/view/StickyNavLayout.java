...
public class StickyNavLayout extends LinearLayout {
	...
	public boolean isInControl = false;
	public boolean isTopPartlyHidden = false;//部分显示
	
	public boolean isScrollDown;//是否能向下滚动
...
//					if (!isTopHidden || (c != null && c.getTop() == 0 && isTopHidden && dy > 0)) {
					...
					Log.i("xxxxxxxxxxxxxxx", "isTopPartlyHidden:"+isTopPartlyHidden + ",isTopHidden:" + isTopHidden + ",c.getTop():"+c + ",dy:"+dy);
					
					if (!isTopPartlyHidden && !isTopHidden && (c == null && dy > 0)) {
						
//						Log.i("xxxxxxxxxxxxxxx", "isTopPartlyHidden:"+isTopPartlyHidden + ",isTopHidden:" + isTopHidden + ",c.getTop():"+c.getTop() + ",dy:"+dy);
						
						return false;
					} else  if ((!isTopHidden && !(c != null && c.getTop() == 0 && dy > 0))
							|| isTopPartlyHidden
