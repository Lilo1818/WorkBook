...
public class PreferencesUtils {
	public static String PREFERENCE_NAME = "XL";
	 ...
	 * @param value
	 */
	public static void setStarId(Context context,int value){
		putInt(context, "star_id", value);
	}
	 ...
	 * @return
	 */
	public static int getStarId(Context context){
		return getInt(context, "star_id", -1);
	}
